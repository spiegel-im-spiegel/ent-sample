...
// AddOwned adds the "owned" edges to the BinaryFile entity.
func (uu *UserUpdate) AddOwned(b ...*BinaryFile) *UserUpdate {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
// ClearOwned clears all "owned" edges to the BinaryFile entity.
func (uu *UserUpdate) ClearOwned() *UserUpdate {
	uu.mutation.ClearOwned()
	return uu
}

// RemoveOwnedIDs removes the "owned" edge to BinaryFile entities by IDs.
func (uu *UserUpdate) RemoveOwnedIDs(ids ...int) *UserUpdate {
	uu.mutation.RemoveOwnedIDs(ids...)
	return uu
}

// RemoveOwned removes "owned" edges to BinaryFile entities.
func (uu *UserUpdate) RemoveOwned(b ...*BinaryFile) *UserUpdate {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
// AddOwned adds the "owned" edges to the BinaryFile entity.
func (uuo *UserUpdateOne) AddOwned(b ...*BinaryFile) *UserUpdateOne {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
// RemoveOwned removes "owned" edges to BinaryFile entities.
func (uuo *UserUpdateOne) RemoveOwned(b ...*BinaryFile) *UserUpdateOne {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
